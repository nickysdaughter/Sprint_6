class TestData:
    ...
    FIRST_USER_DATA = ['Иван', 'Иванов', 'ул Мира, 137', 'Черкизовская', '+79077776655', '01.04.2025',
                 'Тест']

    SECOND_USER_DATA = ['Тестовое Имя', 'Фамилия', '', 'Красносельская', '+79112223344', '25.04.2025',
                 'Тест-Тест-Тест']